      ...
      <div id="postsContainer" class="mt-6 flex flex-col gap-2 divide-y divide-zinc-700">
        ...
        <div id="thePosts" class="flex flex-col">
          <?php foreach($userPosts as $post):?>
            ...
            <div id="postContainer" class="p-2 font-archivo hover:bg-zinc-800/50 border-y-[1px] border-zinc-700" onclick="navigateToPost('<?php echo $post['username'];?>', <?php echo $post['postID'];?>)">
